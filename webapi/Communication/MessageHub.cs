...
namespace webapi.Communication
{
    public class MessageHub : Hub
    {
        public async Task<string> JoinGameGroup(int gameID, string username)
        {
            ...
            await Clients.Group("Game" + gameID).SendAsync(username + " has joined the game!");
        ...
        public async Task<string> LeaveGameGroup(int gameID, string username)
        {
            ...
            await Clients.Group("Game" + gameID).SendAsync(username + " has left the game!");
        ...
        {
            await Clients.User("User" + userID).SendAsync(inviteFrom + " has invited you to a game!");
